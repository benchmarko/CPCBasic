...
190 if t$=chr$(13) then t$=hex$(p+1)
...
1020 READ ton,dauer
1030 IF ton=-1 or inkey$<>"" THEN WHILE SQ(4)<>4:call &bd19:WEND:return
...
1120 READ ton,dauer:IF ton=-1 or inkey$<>"" THEN WHILE SQ(4)<>4:call &bd19:WEND:return
